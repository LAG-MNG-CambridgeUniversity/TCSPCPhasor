function [fig,LifetimeMat,sub_Mat] = lifetimefigs(subx,suby,fracMol_dIn,binIm_dd,mask_P_dd,dataMatrix_dd,CLIM_d,dataname,datanum,k,type,savelocation)
load('jet_new');
%for k=1:n*datanum 
...
%     set(h,'YTick',yTickNumbers,'YTickLabel',labels);
    figname=sprintf('%s_%s_%d.tif',dataname(datanum),type,k);
